...
$rows = @(
 @('Peters Heating & Air','Tyler O''Berry, Manager/Sales','629-292-1310 cell / 615-757-5497','toberry@petershvac.net','QUOTE IN HAND','$11,270 = $8,520 unit + $2,750 duct, less $300 TVA rebate. Includes a $95 permit line that should come off (no permit needed for like-for-like).','$11,770 w/ 10-yr labour (+$500); $11,470 after TVA; $11,375 if the $95 permit comes off','GOLD STANDARD. Ask Tyler to drop the $95 permit line next time there is a reason to write. Can start Tue 22 Sept.','Revised proposal 09-17 09:13. ALL FOUR GATES PASS: stainless HX in writing, twist out BOTH sides, 3x 6"->8", 7" garage run, 16" return w/ sheet-metal 90s, static pressure recorded on the invoice. UV light + ecobee installed free. 5-yr labour standard. 2-stage 15.2 SEER2 would add $1,200-1,500; 18" return +$160.','TN #81099 Mechanical'),
 ...
 @('Goodlettsville Heating & Cooling','Bill / Candy Faulkner (office)','615-479-0886','Bill.ghandc@gmail.com','QUOTE IN HAND','$9,760 = $7,960 unit + $1,800 duct. No permit needed (like-for-like, city confirmed, Jeff confirmed 09-17). 18" return +$400. Valid 15 days.','$11,354 w/ 10-yr labour (+$1,594, excludes refrigerant). $116 UNDER Peters over 10 yrs ($21 under once Peters drops the $95 permit).','COMPLETE. Revised quote #1820 09-17 3:14 PM, ALL FOUR GATES PASS. Candy 3:37 PM: "Tax is included in the price." Nothing owed. $9,760 all-in.','Tempstar PGB430060K000B = the 48NL with a Tempstar badge (see comparison PDF 09-17): same coils, blower, HX, sound, weight; Tempstar adds 3-yr No Hassle unit replacement. Revised quote: new square-to-rounds on supply AND return; 16" return re-routed to remove the twist w/ (2) sheet-metal 90s; upsize runs per drawing; garage run; static pressure + airflow recorded on invoice; t-stat wire, ecobee + UV install included. Warranty 3-yr no-hassle, lifetime HX, 10-yr parts registered, 1-yr labour; 2-yr +$550, 5-yr +$864, 10-yr +$1,594. Candy: AHRI airflow is 950 CFM not 995 (true - 995 is the Med-High cooling tap at ~0.5 in ESP on the same blower table, so settable).','TN #72333 (on quote)'),
 ...
 @('Brown and Son (Portland)','Corey','615-325-2624','Corey@hbrownhvac.com','QUOTING','','','Quote promised TONIGHT (Thu 17 Sept) by phone 4:03 PM. Lands on Gmail. Call 615-325-2624 if nothing by Fri AM.','Sent 09-16, re-sent 09-17 10:10 AM after the phone call. Cory@ (one e) bounces - use Corey@. Corey called Jeff 09-17 ~4 PM: quote tonight.',''),
