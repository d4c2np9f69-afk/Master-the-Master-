...
$rows = @(
 ...
 @('Goodlettsville Heating & Cooling','Bill / Candy Faulkner (office)','615-479-0886','Bill.ghandc@gmail.com','QUOTE IN HAND','$9,760 = $7,960 unit + $1,800 duct. Permit NOT included. Valid 15 days.','$11,354 w/ 10-yr labour (+$1,594, excludes refrigerant); + permit = ~$11,450. Within ~$100 of Peters.','Quote #1820 in 09-17 1:56 PM. GATE 1 PASSES. Chased 2:43 PM for the 5 missing items in writing (twist both sides, sheet-metal 90s + 18in price, static pressure on invoice, TN licence #, permit cost). Waiting.','Tempstar PGB430060K000B, 2.5 ton, 14 SEER, 60K BTU. Includes t-stat wire, ecobee install, UV install. Warranty: 3-yr no-hassle, lifetime HX, 10-yr parts (registered), 1-yr labour; 2-yr +$550, 5-yr +$864, 10-yr +$1,594. Duct line is ONE sentence: replace return, upsize runs per drawing, add garage run - not itemised. STAINLESS HX VERIFIED on submittal p1 (Turbo-tubular, stainless). 13.4 SEER2 / 11.05 EER2 / 81% AFUE - same specs as the 48NL.',''),
