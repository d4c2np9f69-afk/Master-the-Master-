...
| ↳ ❌ **Brown and Son** | `Cory@hbrownhvac.com` | 🔴 **HARD BOUNCE — `550 5.4.1 Recipient address rejected: Access denied`** from `hbrownhvac-com.mail.protection.outlook.com`. On Microsoft 365 that means **the mailbox does not exist, or it is set to refuse mail from outside the company.** **Jeff must call (615) 325-2624 and confirm the correct address.** |
