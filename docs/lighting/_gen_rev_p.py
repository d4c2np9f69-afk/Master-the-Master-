...
R = [
    ...
    room(35, 0, 10, 13, "GUEST BED", "door on its SOUTH wall", "#e9f5ec", NEW, 3.0),
    room(45, 0, 11, 6, "CLOSETS", "my guess", "#f4f1e8", NEW, 2.2, True),
    room(45, 6, 11, 11, "GUEST BATH", "SHRUNK 143 &rarr; 121 &middot; tub + sink", "#f9eef1", NEW, 2.6),
...
F = [
    ...
    fx(47.5, 8.5, "tub"), fx(54, 12.5, "sink"),
...
head = (u"<title>HCC Floor Plan — Rev P</title>\n" + style +
        u'\n<section class="sheet"><div class="mast">'
        u'<div class="rev">Rev P &middot; 22 Sep 2026 9:08 AM &middot; solved from your sentence<br>anchored on the 12&times;24 garage</div>'
        u'<h1>Floor Plan &mdash; Rev P<span class="draftbadge">the doors line up</span></h1>'
...
io.open("HCC_Floorplan_REV_P.html", "w", encoding="utf-8").write(head + svg + panel)
print("Rev P built")
