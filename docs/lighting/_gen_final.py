...
G=HX
ROOMS=[
 rm(0.8,SB+.8,13,24,"GARAGE","24&#215;13","#fdf7ec","#8a5000",2.6,False,10),
 rm(G,0,15,11,"MASTER BED","15&#215;11","#e8eef8",M,2.6,False,9.6),
 rm(G,11,3.5,8,"clo","","#f4f1e8",M,1.6,False,7),
 rm(G+3.5,11,8,8,"MASTER BATH","8&#8242; to shower end","#f7f5ea",M,2.6,False,8.8),
 rm(G+11.5,11,3.5,8,"clo","","#f4f1e8",M,1.6,False,7),
 rm(G,19,3.5,3,"clo","","#f4f1e8",M,1.6,False,7),
 rm(G+3.5,19,7.917,3,"LAUNDRY","7&#8242;11&#8243;&#215;3&#8242;","#f7f5ea",M,2.4,False,8),
 rm(G+11.42,19,3.58,3,"linen","","#f4f1e8",M,1.6,False,7),
 rm(G,22,16,13,"KITCHEN / DINING","16&#215;13","#eef6ee",M,2.6,False,9.6),
 rm(G-3,5,3,3,"WC","3&#8242;","#f9eef1",M,2.6,False,7.6),
 rm(G+15.4,0,8,6,"FOYER","8&#215;6 &middot; coat clo","#eef7f3",M,2.6,False,8.8),
 rm(G+28.4,0,11,10,"GUEST BED","11&#215;10","#e9f5ec",M,2.6,False,9.6),
 rm(G+18.4,6.6,10,8.5,"GUEST BATH","~10&#215;8&#189;","#f9eef1",F,2.4,True,8.4),
 rm(G+15.4,15.4,14,17,"LIVING ROOM","14&#215;17","#eaf4f8",M,2.6,False,9.6),
 rm(G+29.4,16.2,10,13,"OFFICE / BED 3","10&#215;13","#e9f5ec",M,2.6,False,9.0),
]
HALL=('<rect x="%s" y="%s" width="%s" height="%s" fill="#f4f8fb" stroke="%s" stroke-width="2.2" stroke-dasharray="6 4"/>'
...
.layout{display:grid;grid-template-columns:1fr 580px;gap:16px;align-items:start}svg{width:100%;height:auto;display:block}
.lists{display:grid;grid-template-columns:1fr 1fr 1fr;gap:9px}
...
html=(u"<title>HCC Floor Plan — FINAL</title>\n"+style+
 u'\n<section class="sheet"><div class="mast">'
 u'<div class="rev">FINAL &middot; 22 Sep 2026 11:37 AM<br>measured &middot; 13 px per foot</div>'
 u'<h1>HCC Floor Plan &amp; Device Key<span class="badge">MEASURED</span></h1>'
 ...
 u'</div></div></section>')
io.open("HCC_Floorplan_FINAL.html","w",encoding="utf-8").write(html)
print("FINAL built - %d numbered items"%n)
