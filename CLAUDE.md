...
**📄 WHUD BILL REFERENCE (from Jeff's bill photo IMG_0844, 2026-07):** provider **White House Utility District**; **Meter ID `25394131`** (= Kamstrup register S/N); **billing cycle reads ~the 21st–22nd** (bill shown: 5/21→6/22/2026, 32 days); **Usage 6,839 gal** that cycle (Current Reading 9640, Previous 2801). **WATER RATES eff 2026-01-01: Base $10.32 + $0.00908/gallon** (meters under 1"); + sewer + sales tax (that bill: water $72.42, tax $7.06, total $79.48). **⚠️ READING-SCALE MISMATCH TO RESOLVE:** bill's meter reading = **9640** but our RTL-SDR (MIU endpoint 79453337) reads raw 129,845 → ÷10 = **12,984** (which CLAUDE.md said matched the Kamstrup LCD). The bill counter and our radio counter don't line up on absolute value (need Jeff to read the current physical LCD to lock calibration). **PLAN (not yet built):** align water "This Month" to the 21st billing cycle (not calendar 1st) + add water Est. Cost from the rates; usage *delta* from our sensor is self-consistent regardless of the absolute-value question.
