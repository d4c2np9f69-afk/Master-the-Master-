...
$out += ""
$out += "  IF A .ps1 WILL NOT RUN (execution policy / sandbox), use this form -"
$out += "  verified working 2026-08-22:"
$out += "     powershell -NoProfile -ExecutionPolicy Bypass -File `"<full path>`""
$out += "  Do NOT silently skip the verification because the script was blocked."
$out += "###########################################################################"
$out += ""
